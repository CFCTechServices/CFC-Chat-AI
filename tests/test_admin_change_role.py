...
ADMIN_EMAIL: str = None  # TODO: Set your admin email here
ADMIN_PASSWORD: str = None  # TODO: Set your admin password here

# Target user to change role
TARGET_USER_ID: str = None  # TODO: The UUID of the user whose role you want to change
NEW_ROLE: str = None  # TODO: One of: 'user', 'dev', 'admin'
