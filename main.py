...
# videos disabled — openai-whisper not yet installed on this VM; re-enable after: pip install openai-whisper
...
# app.include_router(videos.router)  # disabled — openai-whisper not yet installed
